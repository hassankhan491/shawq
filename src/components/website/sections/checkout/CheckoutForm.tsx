  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <label className="flex items-center justify-between p-4 border border-[#2A2520]/20 cursor-pointer hover:border-[#2A2520]/40 transition-colors">
          <div className="flex items-center gap-3">
            <input
              ...
              className="w-4 h-4"
            />
            <span className="text-sm text-[#2A2520]">Credit card</span>
          </div>
        ...
        <label className="flex items-center justify-between p-4 border border-[#2A2520]/20 cursor-pointer hover:border-[#2A2520]/40 transition-colors">
          <div className="flex items-center gap-3">
            <input
              ...
              className="w-4 h-4"
            />
            <span className="text-sm text-[#2A2520]">Shop Pay • Pay in full or in installments</span>
          </div>
          <span className="text-purple-600 font-medium text-sm">shop</span>
        </label>
        ...
        <label className="flex items-center justify-between p-4 border border-[#2A2520]/20 cursor-pointer hover:border-[#2A2520]/40 transition-colors">
          ...
          <span className="text-blue-600 font-medium text-sm">PayPal</span>
        </label>
        ...
        <label className="flex items-center justify-between p-4 border border-[#2A2520]/20 cursor-pointer hover:border-[#2A2520]/40 transition-colors">
          ...
          <span className="text-teal-500 font-medium text-sm">Afterpay</span>
        </label>
      </div>

      {/* Billing Address */}
      <div className="space-y-3 pt-6 border-t border-[#2A2520]/10">
        <h3 className="text-sm font-medium text-[#2A2520]">Billing address</h3>
        <label className="flex items-center gap-3 cursor-pointer">
          <input
            type="radio"
            name="billing"
      ...
      <div className="pt-4">
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          />
          <div>
            <p className="text-sm text-[#2A2520]">Save my information for a faster checkout</p>
          ...
          <button className="ml-auto text-xs text-[#2A2520]/60 hover:text-[#2A2520]">
            Not now
          </button>
        </label>
      </div>
      ...
      {/* Pay Button */}
      <button className="w-full py-4 bg-[#2A2520] text-[#FAF7F2] text-xs uppercase tracking-[0.25em] hover:bg-[#B8935A] transition-colors mt-6">
        Pay now
      </button>
    </div>
  );
