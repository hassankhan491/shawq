...
const CartIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="w-5 h-5">
    <path d="M16 11V7a4 4 0 10-8 0v4M5 9h14l1 12H4L5 9z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export default function Header() {
  ...
  // ✅ Hero khatam hone par header compress
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (hero) {
        ...
        if (spacer && spacer.classList.contains("pin-spacer")) {
          end = spacer.offsetHeight - window.innerHeight;
        }
      }

      setIsScrolled(window.scrollY > end);
    };
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-out">
        ...
        >
          {/* ✅ 3-COLUMN GRID - logo hamesha perfect center */}
          <div
