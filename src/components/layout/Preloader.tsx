  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(
        ...
        .to(
          ".ld-bottom",
          { autoAlpha: 0, y: -24, duration: 0.45, ease: "power2.in" },
          "<",
        )
    ...
    />
        ...
        <div className="relative flex h-full w-full flex-col items-center justify-center gap-4 px-6">
          <div className="ld-mask overflow-hidden">
            {/* Added px-6 to prevent the Q tail from cutting on the right, and mx-[-1.5rem] to keep it centered */}
            <span
              className="block text-[20vw] sm:text-[14vw] lg:text-[10vw] leading-tight tracking-wide text-[var(--color-header-font)] drop-shadow-2xl py-4 px-6 mx-[0.5rem]"
          ...
          <div className="ld-mask overflow-hidden">
            <span
              className="block italic text-xl sm:text-3xl lg:text-4xl tracking-[0.08em] text-white drop-shadow-xl"
        ...
        <div className="ld-bottom absolute inset-x-0 bottom-0 px-6 pb-6 sm:px-10 sm:pb-8">
          <div className="mb-4 flex items-end justify-between">
            <span
              ref={countRef}
              className="font-sans text-xs tracking-[0.3em] text-[var(--color-header-font)] sm:text-sm drop-shadow-lg"
              style={{ fontFamily: "var(--font-decorative)" }}
            >
              000
            </span>
            <span
              className="font-sans text-[10px] uppercase tracking-[0.3em] text-white/80 sm:text-xs drop-shadow-lg"
              style={{ fontFamily: "var(--font-decorative)" }}
            >
              Eau de Parfum
            </span>
