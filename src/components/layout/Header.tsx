...
export default function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // 80px scroll ke baad header shrink hoga
  ...
  return (
    <>
      {/* Premium Header with Smooth Transition */}
      <header
        className={`
      ...
      >
        ...
        <div
          className={`
            ...
            ${
              isScrolled
                ? "max-w-6xl mx-auto mt-4 px-6 rounded-2xl border border-[#c9a962]/30 bg-[#0f0a08]/90"
                : "px-6 lg:px-12"
            }
          `}
        >
          ...
          >
            ...
            >
              <span
                className={`
                font-medium text-xs tracking-[0.2em] uppercase hidden sm:block
            ...
            >
              <h1
                className={`
                font-serif font-medium tracking-wide transition-all duration-300
                ${
                  isScrolled
                    ? "text-2xl lg:text-3xl text-[#c9a962]"
            ...
            <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
              ...
              <button
                className={`
                  hidden md:flex p-2 rounded-full transition-all duration-300 group
                  ${isScrolled ? "text-[#c9a962] hover:bg-[#c9a962]/10" : "text-white hover:bg-white/10"}
                `}
                aria-label="Search"
              >
                <SearchIcon />
              ...
              <button
                className={`
                  hidden sm:flex p-2 rounded-full transition-all duration-300 group
                  ${isScrolled ? "text-[#c9a962] hover:bg-[#c9a962]/10" : "text-white hover:bg-white/10"}
                `}
                aria-label="Account"
              >
